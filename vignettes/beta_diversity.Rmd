...
"char" variable. 
**Note, however, that the p-value tells us nothing about across which groups centroids may differ or how they differ. A small p-value does not guarantee that all group centroids differ, or that any pair of groups differ in scientifically important ways.**
...
colnames(specimen_df) <- unique_specimens
```
