...
confidence intervals, particularly in groups with smaller sample sizes (such as "water", where -- eek -- $n = 2$).
...
otu_matrix <- B2 %>% dplyr::select(starts_with("k_"))  %>% t() %>%as.data.frame()
