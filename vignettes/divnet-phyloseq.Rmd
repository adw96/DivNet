...
Why are the estimates all the same? We didn't tell DivNet about any covariate information, so it just assumes that all the samples are from the same population. But we have information about the samples and the conditions under which they observed:
...
# 
# plot_bar(tax_glom(Lee, taxrank="Phylum"), x = "char", facet_grid = ~Phylum)
# plot_bar(Lee, fill="Phylum")
# Lee %>%
