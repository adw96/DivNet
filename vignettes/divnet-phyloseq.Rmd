...
WARNING: DivNet can be computationally expensive when analysing many taxa. Start with sub-setting taxa, or analysing at a higher taxonomic level than ASVs,  to start. Here is an example of the syntax for analysing biological replicates of a Mock community
